...
const ServoSettings servoSettings[] PROGMEM = {
    ...
    // --- BOARD 1 (Pins 1-16) ---
    // Holo Servos start at Position 1 of the first board (Pin 1)
    {1, 800, 2200, HOLO_HSERVO}, /* 0: horizontal front holo */
    {2, 800, 2200, HOLO_VSERVO}, /* 1: vertical front holo */
    {3, 800, 2200, HOLO_HSERVO}, /* 2: horizontal top holo */
    {4, 800, 2200, HOLO_VSERVO}, /* 3: vertical top holo */
    {5, 800, 2200, HOLO_VSERVO}, /* 4: vertical rear holo */
    {6, 800, 2200, HOLO_HSERVO}, /* 5: horizontal rear holo */

    // --- BOARD 2 (Pins 17-32) ---
    // Panels to start at Position 1 of the second board (Pin 17)
    {17, 800, 2200, PANEL_GROUP_4 | SMALL_PANEL},  /* 6: door 4 */
    {18, 800, 2200, PANEL_GROUP_3 | SMALL_PANEL},  /* 7: door 3 */
    {19, 800, 2200, PANEL_GROUP_2 | SMALL_PANEL},  /* 8: door 2 */
    {20, 800, 2200, PANEL_GROUP_1 | SMALL_PANEL},  /* 9: door 1 */
    {21, 800, 2200, PANEL_GROUP_5 | MEDIUM_PANEL}, /* 10: door 5 */
    {22, 800, 2200, PANEL_GROUP_6 | BIG_PANEL},    /* 11: door 9 */
    {23, 800, 2200, MINI_PANEL},                   /* 12: mini door 2 */
    {24, 800, 2200, MINI_PANEL},                   /* 13: mini front psi door */
    {25, 800, 2200, PANEL_GROUP_10 | PIE_PANEL},   /* 14: pie panel 1 */
    {26, 800, 2200, PANEL_GROUP_9 | PIE_PANEL},    /* 15: pie panel 2 */
    {27, 800, 2200, PANEL_GROUP_8 | PIE_PANEL},    /* 16: pie panel 3 */
    {28, 800, 2200, PANEL_GROUP_7 | PIE_PANEL},    /* 17: pie panel 4 */
    {29, 800, 2200, TOP_PIE_PANEL},                /* 18: dome top panel */
#endif
};
...
void saveHoloSettings()
{
    if (burstMin > burstMax) { int t = burstMin; burstMin = burstMax; burstMax = t; }
    if (burstSpeedMin > burstSpeedMax) { int t = burstSpeedMin; burstSpeedMin = burstSpeedMax; burstSpeedMax = t; }
    if (idleMin > idleMax) { int t = idleMin; idleMin = idleMax; idleMax = t; }

    preferences.putInt(PREFERENCE_HOLO_BURST_MIN, burstMin);
    preferences.putInt(PREFERENCE_HOLO_BURST_MAX, burstMax);
    preferences.putInt(PREFERENCE_HOLO_BSPEED_MIN, burstSpeedMin);
...
void setup()
{
    ...
    {
        burstMin = preferences.getInt(PREFERENCE_HOLO_BURST_MIN, 1);
        burstMax = preferences.getInt(PREFERENCE_HOLO_BURST_MAX, 4);

        burstSpeedMin = preferences.getInt(PREFERENCE_HOLO_BSPEED_MIN, 300);
        burstSpeedMax = preferences.getInt(PREFERENCE_HOLO_BSPEED_MAX, 800);
